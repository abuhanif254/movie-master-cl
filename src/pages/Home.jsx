...
import StatsSection from '../components/StatsSection'; // New Import
import { Link } from 'react-router-dom';
import { FaUserShield } from "react-icons/fa"; 
import AOS from 'aos'; // Animation Import
...
const Home = () => {
    ...
    useEffect(() => {
        // 1. Animation Init
        AOS.init({
            duration: 1000, // অ্যানিমেশন সময় ১ সেকেন্ড
            once: true, // একবারই এনিমেট হবে
        });
